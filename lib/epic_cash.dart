...
typedef ProcessSlates = Pointer<Utf8> Function(Pointer<Utf8>, Pointer<Utf8>);
typedef ProcessSlatesFFI = Pointer<Utf8> Function(Pointer<Utf8>, Pointer<Utf8>);
...
typedef EncryptSlate = Pointer<Utf8> Function(
    Pointer<Utf8>, Pointer<Utf8>, Pointer<Int8>, Pointer<Utf8>, Pointer<Utf8>);
typedef EncryptSlateFFI = Pointer<Utf8> Function(
    Pointer<Utf8>, Pointer<Utf8>, Pointer<Int8>, Pointer<Utf8>, Pointer<Utf8>);

typedef PostSlateToNode = Pointer<Utf8> Function(Pointer<Utf8>, Pointer<Utf8>);
...
Future<String> getSubscribeRequest(
    String wallet, int secretKeyIndex, String epicboxConfig) async {
...
Future<String> processSlates(String wallet, String slates) async {
  return _processSlates(wallet.toNativeUtf8(), slates.toNativeUtf8())
      .toDartString();
}
...
Future<String> postSlateToNode(String wallet, String txSlateId) async {
  return _postSlateToNode(wallet.toNativeUtf8(), txSlateId.toNativeUtf8())
      .toDartString();
}

#ifndef EPIC_CASH_WALLET_H
#define EPIC_CASH_WALLET_H
...
void epic_cash_string_free(char *value);
...
const char *rust_delete_wallet(const char *wallet, const char *config);
...
void *rust_epicbox_listener_start(const char *wallet,
                                  const char *epicbox_config);

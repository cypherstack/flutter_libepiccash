...
class _CancelTransactionsViewState extends State<CancelTransactionsView> {
  ...
  Future<void> _loadTransactions() async {
    ...
    try {
      ...
      final wallet = await epic.EpicWallet.load(
        ...
        epicboxConfig: EpicboxConfig.getEpicboxServerConfig(),
      );
      final transactions = await wallet.getTransactions(refreshFromNode: 1);
  ...
  Future<void> _cancelTransaction(String? txSlateId, int txId) async {
    ...
    try {
      ...
      await _wallet!.cancelTransaction(transactionId: txId.toString());
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isCancelling = _cancelling.contains(tx.txSlateId);
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          leading: CircleAvatar(
                            backgroundColor: tx.txType == TransactionType.TxSent
                                ? Colors.red[100]
                                : Colors.blue[100],
                            child: Icon(
                              ...
                              color: tx.txType == TransactionType.TxSent
                                  ? Colors.red
                                  : Colors.blue,
                            ),
                          ),
                          ...
                          trailing: isCancelling
                              ...
                              : ElevatedButton.icon(
                                  onPressed: () =>
                                      _cancelTransaction(tx.txSlateId, tx.id),
